...
from .views import (AddEmpAPIView,GetEmployeeListAPIView,DeleteEmpAPIView,UpdateEmpAPIView,EMPListView,getEmpDetailsAPIView)
urlpatterns=[
    ...
    url('getEMPLIST',EMPListView.as_view()),
